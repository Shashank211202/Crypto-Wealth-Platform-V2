# KUCH V - Premium Crypto Investment Platform
...
**KUCH V** is a high-performance, hyper-polished crypto investment ecosystem designed for the modern investor. Built on a robust **MERN Stack** architecture, it features a glassmorphism UI, real-time market data, advanced admin controls, and secure multi-currency transaction handling.
...
## 📚 Documentation
- [Usage Features](file:///d:/self%20project/KUCH%20V/client/FEATURES.md)
- [Technical Implementation](file:///d:/self%20project/KUCH%20V/client/TECHNICAL_DETAILS.md)
- [API Documentation](file:///d:/self%20project/KUCH%20V/server/API_DOCS.md)
...
- If running locally, it's usually `http://localhost:5173` (Vite).
...
Built with ❤️ by [aadityaexe](https://github.com/aadityaexe)
